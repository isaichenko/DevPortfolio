module ApplicationHelper
  ...
  def source_helper(styles)
    if session[:source]
      greeting = "Thanks for visiting me from <em><b>#{session[:source]}</em></b>, please fell free to #{ link_to 'contact me', contact_path } if you'd like to work together."
  ...
  def alert_generator msg
    js add_gritter(msg, title: "Eugene Isaichenko Portfolio", sticky: false)
  end
